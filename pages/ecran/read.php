        ...
        <div class="panel panel-default">
            <div class="panel-body">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Ajouter un écran</h5>
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm float-right" data-toggle="modal" data-target="#ajoutsalle"><i class="fas fa-plus fa-sm text-white-50"></i> Ajouter un écran</a>
                </div>
        ...
        $(document).ready(function(){
            ...
            $('#sample_data').on('draw.dt', function(){
                $('#sample_data').Tabledit({
                    url:'http://localhost:8888/Admin/pages/ecran/action.php',
                    dataType:'json',
                    buttons: {
                        edit: {
