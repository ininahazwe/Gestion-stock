...
$req = $connect->prepare("SELECT id, nom, localisation FROM salle");
$req->execute();
$salles = $req->fetchAll();
?>
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        ...
                        <div class="row mt-1 float-right">
                            <a href="view.php?id=<?= $salle['id']?>" class="btn btn-info m-1 btn-circle btn-sm">
                            ...
                            <form action="../../traitements/traitement-salles.php" method="POST">
                                ...
                                <div>
                                    <input type="submit" value="X" class="btn btn-danger m-1 btn-circle btn-sm">
                                </div>
                            </form>
                        </div>
                    </div>
